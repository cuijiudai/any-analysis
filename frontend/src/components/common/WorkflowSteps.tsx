          ...
          title: (
            ...
            >
              <span style={{ 
                ...
                color: current === index ? '#1890ff' : completedSteps.includes(index) ? '#52c41a' : '#666'
              }}>
                {step.title}
              </span>
              ...
              {completedSteps.includes(index) && (
                <Badge 
                  count={<CheckCircleOutlined style={{ color: '#52c41a', fontSize: 12 }} />} 
                  style={{ marginRight: 6 }}
                />
              )}
          ...
          icon: (
            <div
              style={{
                ...
                color: (current === index || completedSteps.includes(index)) ? '#fff' : '#999',
                fontSize: 16,
                fontWeight: 500,
